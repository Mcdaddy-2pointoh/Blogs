...
export default function Blog() {
  ...
  let blogName = location.pathname.replace("/blog/", "");
  ...
  const [blogs, setBlog] = useState([
    ...
    {
      blogGenre: ["Compute", "Science", "Quantum Physics"],
      blogTitle: "Quantum Computing",
      blogContent:
      ...
      blogImage:
        "https://phonemantra.com/wp-content/uploads/2020/05/Quantum-computers.jpg",
      email: "sharvil.d@somaiya.edu",
      date: `${new Date()}`,
    },
  ]);
    ...
    <ThemeProvider theme={theme}>
      ...
      <main style={{ background: "#f6efcb" }}>
            ...
            <Grid container>
              ...
              >
                <img
                  ...
                  style={{ borderRadius: "1em", maxWidth: "80vw" }}
                  alt="Blog Image"
                />
              </Grid>

              <Grid item xs={12}>
                <Typography variant="h4" align="center" color="#eee" paragraph>
                  {blogData.blogTitle}
                </Typography>
              </Grid>
            </Grid>
        ...
        <Container sx={{ py: 8 }} maxWidth="md">
          <Grid item container xs={12} style={{ margin: "1% 0" }}>
            <Grid item xs={12}>
              <Typography
                variant="h3"
            ...
            {blogData.blogGenre.map((value, index) => {
              return (
                <Grid item style={{ padding: 0, margin: "0 1% 0 0" }}>
